...
class PostProvider with ChangeNotifier {
  ...
  void createPost(String title, String content, String uid, String unm) {
    ...
    ref.set({'content': content, 'title': title, 'uid': uid, 'unm': unm, 'rootPostDID':rootPostDID, 'parentPostDID':parentPostDID})
  ...
  void updatePost(String title, String content){
    _title = title;
    _content = content;
    posts.doc(_currentDocId).set({'content': content, 'title': title})
  ...
  void deletePost(){
    ...
    posts.doc(deleteDID).set({'unm':'익명'})
